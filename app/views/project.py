...
def index(project_id=None):
    ...
    try:
        ...
        if project_id:
            ...
            if current_project:
                logger.info(f"Using session project: {current_project.name} (ID: {session['project_id']})")
...
def list_projects():
    ...
    try:
        ...
        logger.info(f"Project list requested by {current_user.username} - filters: name='{name}', status='{status}'")
...
def create_project():
    ...
    try:
        ...
        logger.info(f"Project creation requested by {current_user.username} - name: {data.get('name')}")
        ...
        logger.info(f"Project created successfully - ID: {project.id}, Key: {project.key}, Name: {project.name}")
...
def update_project():
    ...
    try:
        ...
        logger.info(f"Project update requested by {current_user.username} - ID: {project.id}, Name: {project.name}")
...
def delete_project():
    ...
    try:
        ...
        logger.info(f"Project deletion requested by {current_user.username} - ID: {project.id}, Name: {project.name}")
        ...
        logger.info(f"Project marked as deleted - Status changed: {old_status} -> deleted")
...
def detail(project_id):
    ...
    try:
        ...
        logger.info(f"User {current_user.username} accessing project details - ID: {project.id}, Name: {project.name}")
